...
_URLS = {
    "train": '/content/drive/MyDrive/QA/train-v2-possible-back-trans-synonym-aug.json',
    "dev": '/content/drive/MyDrive/QA/dev-v2.0.json',
}


class SquadV2AUGConfig(datasets.BuilderConfig):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(SquadV2AUGConfig, self).__init__(**kwargs)


class SquadV2AUG(datasets.GeneratorBasedBuilder):
    """TODO(squad_v2): Short description of my dataset."""

    # TODO(squad_v2): Set up version.
    BUILDER_CONFIGS = [
        SquadV2AUGConfig(name="squad_v2", version=datasets.Version("2.0.0"), description="SQuAD plaint text version 2"),
    ]
    ...
    def _info(self):
        ...
        return datasets.DatasetInfo(
            ...
            homepage="https://huggingface.co/datasets/sichenzhong/squad_v2_back_trans_synonym_possib_aug",
            citation=_CITATION,
            task_templates=[
